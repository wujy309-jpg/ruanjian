...
public class VideoCategoryController {
    ...
    public Result<List<VideoCategory>> getChildCategories(@Parameter(description = "父级分类ID") @PathVariable Long parentId) {
    ...
    public Result<VideoCategory> getCategoryById(@Parameter(description = "分类ID") @PathVariable Long id) {
    ...
    @Operation(summary = "启用/禁用分类信息", description = "启用/禁用分类")
    public Result<Void> toggleEnable(@RequestBody VideoCategory category) {
        videoCategoryService.toggleEnable(category.getId(), category.getStatus());
        return Result.success(null);
    }
